            ...
            <div style={styles.wrapper}>
                <main style={styles.container}>
                    ...
                    <div style={styles.info}>
                        ...
                        {product.category && (
                            <p style={styles.category}>Danh mục: {product.category.name}</p>
                        )}
                        ...
                        <div style={styles.extraInfo}>
                            ...
                            <p>✅ Cam kết rau củ tươi, có nguồn gốc rõ ràng</p>
                            <p>↩️ Đổi trả miễn phí nếu sản phẩm không đạt yêu cầu</p>
                        </div>
                    </div>
                </main>
                ...
                {relatedProducts.length > 0 && (
                    <section style={styles.relatedSection}>
                        <h3 style={styles.relatedTitle}>Sản phẩm gợi ý</h3>
